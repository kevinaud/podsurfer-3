...
public class PodsurferAPI {
	...
	public Response getUserInfo(String token) throws Exception {
  ...
  public Response apiGetRequest(String endpoint, String headerKey, String headerValue) throws Exception {
	...
	public com.fasterxml.jackson.databind.JsonNode apiGetRequestJson(String endpoint, String headerKey, String headerValue) throws Exception {
