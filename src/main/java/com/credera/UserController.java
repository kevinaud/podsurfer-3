...
public class UserController {
	...
	public Response getUserInfo(@RequestHeader("Authorization") String token) throws Exception {
	...
	public String getUserPreferences(@RequestHeader("Authorization") String token) throws Exception {
	...
	public Response updateUserPreferences(@RequestHeader("Authorization") String token, @RequestBody String userPreferences) throws Exception {
    ...
    public Response getUserInfo(@RequestHeader("Authorization") String token, @RequestHeader("Server") String server) throws Exception{
        if(server == "podsurfer"){
          return papi.getUserInfo(token);
        }
